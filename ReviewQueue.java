...
public class ReviewQueue {
    ...
    public void enqueue(emissionRecords record) {//adds record to the end
    ...
    public emissionRecords dequeue() { //removes the first element
        if (front == null) {
            return null;
        }

        emissionRecords removed = front.data;
        front = front.next;
    ...
    public emissionRecords peek() {//shows us the first record in the queue but doesnt delete it
        if (front == null) {
            return null;
        }
        return front.data;
