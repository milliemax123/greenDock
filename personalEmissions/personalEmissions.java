...
public class personalEmissions {
    ...
    private double myCo2;
    
    public personalEmissions(String date, double carKm, int busTrips, int flights, String dietType, double houseSize, String heatingType, double myCo2){
        this.date = date;
        this.carKm=carKm;
    ...
    public String toString() {
        return date + "," + myCo2 + "," + carKm + "," + busTrips + "," +
               flights + "," + houseSize + "," + heatingType + "," + dietType;
    }
}
